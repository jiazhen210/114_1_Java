...
public class Account {
    ...
    private Date openingDate; // 帳戶開立日期
    private Time2 openingTime; // 帳戶開立時間
    ...
    public Account(String accountNumber, double initialBalance) {
        this(accountNumber, "未知",ownerName:"未知",ownerID:"0000", initialBalance);
    }
    ...
    public String toString() {
        return String.format("帳戶號碼: %s, 持有人: %s, 餘額: %.2f, 開立日期:%s, 開立時間:%s",
                accountNumber,owner., balance, openingDate, openingTime);
